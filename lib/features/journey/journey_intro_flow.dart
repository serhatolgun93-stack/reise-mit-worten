...
class _JourneyIntroFlowState extends State<JourneyIntroFlow> {
      ...
      body: Stack(
        ...
        children: [
          AnimatedSwitcher(
            ...
            child: Image.asset(
              _activeBackground,
              key: ValueKey(_activeBackground),
              fit: BoxFit.cover,
  ...
  Widget _guideLayer(Size screen, bool landscape) {
    ...
    if (landscape) {
      return Positioned(
        ...
        child: IgnorePointer(
          child: SizedBox(
            width: screen.width *
                (_step == 2 ? 0.31 : (_step == 3 ? 0.28 : 0.34)),
            height: screen.height * 0.86,
            child: Image.asset(
              _guideAsset,
              fit: BoxFit.contain,
              alignment:
                  onRight ? Alignment.bottomRight : Alignment.bottomLeft,
              filterQuality: FilterQuality.high,
    ...
    return Positioned(
      left: onRight ? null : -34,
      right: onRight ? -42 : null,
      bottom: _step == 2 ? 108 : (_step == 3 ? 118 : 138),
      child: IgnorePointer(
        child: SizedBox(
          width: screen.width *
              (_step == 2 ? 0.61 : (_step == 3 ? 0.48 : 0.67)),
          height: screen.height *
              (_step == 2 ? 0.58 : (_step == 3 ? 0.52 : 0.61)),
          child: Image.asset(
            _guideAsset,
            fit: BoxFit.contain,
  ...
  Widget _stepOnePortrait(Size screen) => Column(
        children: [
  ...
  Widget _stepOneLandscape(Size screen) => Column(
        children: [
          _header('1 / 8', () => Navigator.of(context).pop()),
          const Spacer(),
          Align(
  ...
  Widget _stepTwoPortrait(Size screen) => Column(
  ...
  Widget _stepTwoLandscape(Size screen) => Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          _header('2 / 8', _backToStepOne),
          const Spacer(),
  ...
  Widget _stepThreePortrait(Size screen) => Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
  ...
  Widget _stepThreeLandscape(Size screen) => Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          _header('3 / 8', _backToStepTwo),
  ...
  Widget _header(String step, VoidCallback onBack) => Row(
